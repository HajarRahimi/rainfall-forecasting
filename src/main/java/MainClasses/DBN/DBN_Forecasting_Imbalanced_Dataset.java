...
public class DBN_Forecasting_Imbalanced_Dataset {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int [] columnIndexes = {1,2,3,6,7,9,10,12,15,16,18,20,24,26,28,31,32,33,34,35,36,37,39,43,47,48,49,50,51,52,53,55,65,66,68,70,71,77,81,91,92,94,96,98,103,104,105,106,107,108,109,110,111,112,114,115,119,122,123,124,125,126,127,131,132,134};
        int [] outputIndexes = {137};

        final int numRows = columnIndexes.length;
        final int numColumns = 1;
        int outputNum = 5;
        int numExamples = 2610;
        int batchSize = 1720;
        int iterations = 10;
        int splitTrainNum = (int) (batchSize * .70);
        int seed = 123;
        int listenerFreq = 1;
        String address = "/weather_SpreadSubsample.csv";// weather_SMOTE  or   weather_SMOTE_SpreadSubsample
...
//
        ...
        try {
            ...
            FileWriter writer = new FileWriter("forecast_column_Imbalanced_Dataset.csv");
